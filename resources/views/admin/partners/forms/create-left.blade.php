<div class="col-12 col-md-9">
    ...
    <div class="card mb-3">
        ...
        <div class="row card-body">
            ...
            <div class="col-12">
                <div class="mb-3">
                    <label class="control-label"><i class="ti ti-clock"></i> {{ __('Thời gian mở cửa') }}:</label>
                    <x-input name="opening_time" :value="old('opening_time')" placeholder="{{ __('Thời gian mở cửa') }}" />
                </div>
            </div>
            ...
            <div class="col-12">
                <div class="mb-3">
                    ...
                    <x-textarea maxlength="500" name="description" :value="old('description')" :required="false"
                        placeholder="{{ __('Nhập mô tả') }}" icon="ti-message">
                    </x-textarea>
                </div>
            </div>
        </div>
