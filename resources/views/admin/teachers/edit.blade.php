...
@section('content')
    <div class="page-body">
        <div class="container-xl">
            <x-form :action="route('admin.teacher.update')" type="put" :validate="true">
                <x-input type="hidden" name="id" :value="$instance->id" />
                <div class="row justify-content-center">
                    @include('admin.teachers.forms.edit-left', ['instance' => $instance])
                    @include('admin.teachers.forms.edit-right', ['instance' => $instance])
                </div>
            </x-form>
        </div>
