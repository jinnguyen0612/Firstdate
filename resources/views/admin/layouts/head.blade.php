...
{{-- <link rel="shortcut icon" type="image/x-icon" href="{{ asset('/public/uploads/images/Imagelogo/pngtree-first-date-clipart-young-couple-drinking-coffee-at-table-in-restaurant-png-image_6870220.png') }}" /> --}}
<link rel="shortcut icon" type="image/x-icon" href="{{ asset(admin_setting('favicon','public/admin/assets/images/favicon.png')) }}" />
<!-- CSS files -->
