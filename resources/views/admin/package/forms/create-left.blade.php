        ...
        <div class="row card-body">
            ...
            <div class="col-12 col-md-6 col-sm-6">
                <div class="mb-3">
                    ...
                    <x-input-number name="price" :value="old('price')" :required="true"
            ...
            <div class="col-12 col-md-6 col-sm-6">
                <div class="mb-3">
                    ...
                    <x-input-number name="discount_price" :value="old('discount_price')"
            ...
            <div class="col-12">
                <div class="mb-3">
                    ...
                    <x-input-number name="available_days" :value="old('available_days')"
