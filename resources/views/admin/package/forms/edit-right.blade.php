    ...
    <div class="col-12 col-md-3">
        <div class="card mb-3">
            ...
            <div class="card-body d-flex justify-content-between p-2">
                ...
                <x-button.modal-delete data-route="{{ route('admin.package.delete', $package->id) }}"
                    :title="__('Xóa')" />
            </div>
        </div>
            ...
            <div class="card-header">
                ...
                <div class="mx-2">
                    <label class="heart-switch">
                        ...
                        <input type="checkbox" name="is_active" value="1" {{ $package->is_active === 1 ? 'checked' : '' }} {{ !$isAdmin ? 'disabled' : '' }}>
