<div class="col-12 col-md-3">
    ...
    <div class="card mb-3">
        <div class="card-header">
            <span><i class="ti ti-user-check me-2"></i>{{ __('Hiển thị hồ sơ') }}</span>
            <div class="mx-2">
                <label class="heart-switch">
                    <input type="hidden" name="is_hide" value="1">
                    <input type="checkbox" name="is_hide" value="0">
    ...
    <div class="card mb-3">
        ...
        <div class="card-body p-2">
            <x-input-gallery-ckfinder name="thumbnails" type="multiple" />
        </div>
    </div>
</div>
