...
trait  NotifiesViaFirebase
{
     ...
     */
    public function sendFirebaseNotification(array $deviceTokens, ?string $topic, string $title, string $body, ?int $notificationId = null): void
    {
        $notificationData = [
            'title' => $title,
            'body' => $body
    ...
    public function sendFirebaseNotificationToParents($parents, string $title, string $body): void
    {
        $notificationRepository = app(NotificationRepositoryInterface::class);
