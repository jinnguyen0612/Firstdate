...
class ComponentServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        Blade::component('alert-user', \App\Admin\View\Components\Layout\AlertUser::class);
        ...
        Blade::component('input-base-checkbox', \App\Admin\View\Components\Input\InputBaseCheckbox::class);
        ...
        Blade::component('input-color', \App\Admin\View\Components\Input\InputColor::class);
