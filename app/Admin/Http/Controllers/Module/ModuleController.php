...
class ModuleController extends Controller
{
    ...
    public function index(ModuleDataTable $dataTable)
    {
        return $dataTable->render($this->view['index'], [
            ...
            'breadcrumbs' => $this->crums->add(__('Module'))
        ]);
    }
    ...
    public function create(): Factory|View|Application
    {
        ...
        return view($this->view['create'], [
            ...
            'breadcrumbs' => $this->crums->add(__('Ds Module'), route($this->route['index']))->add(__('add'))
        ]);
    }
    ...
    public function edit($id): Factory|View|Application
    {
        ...
        return view(
            ...
            [
                ...
                'listpermissions' => $listpermissions,
                'status' => ModuleStatus::asSelectArray(),
                'breadcrumbs' => $this->crums->add(__('Ds Module'), route($this->route['index']))->add(__('edit'))
            ]
        );
    }
