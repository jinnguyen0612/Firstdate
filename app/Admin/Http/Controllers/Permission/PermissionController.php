...
class PermissionController extends Controller
{
    ...
    public function index(PermissionDataTable $dataTable)
    {
        ...
        return $dataTable->render($this->view['index'], [
            ...
            'breadcrumbs' => $this->crums->add(__('Ds quyền'))
        ]);
    }
    ...
    public function create()
    {
        ...
        return view($this->view['create'], [
            ...
            'breadcrumbs' => $this->crums->add(__('Ds quyền'), route($this->route['index']))->add(__('add'))
        ]);
    }
    ...
    public function edit($id)
    {
        ...
        return view(
            ...
            [
                ...
                'permission' => $response,
                'types' => PermissionType::asSelectArray(),
                'breadcrumbs' => $this->crums->add(__('Ds quyền'), route($this->route['index']))->add(__('edit'))
            ]
        );
    }
